...
## 🔐 অ্যাডমিন প্যানেল অ্যাক্সেস (Admin Panel Access)

Vercel বা যেকোনো হোস্টিংয়ে ডিপ্লয় করার পর অ্যাডমিন প্যানেলে প্রবেশ করার উপায়:

1. **ইউআরএল দিয়ে প্রবেশ (Admin Route):**
   - ব্রাউজারে সাইটের লিঙ্কের শেষে `/adminriad` লিখে এন্টার দিন (যেমন: `https://your-site.vercel.app/adminriad`)।
   - এছাড়াও সহজ সুবিধার্থে `/admin` বা `#adminriad` বা `#admin`-ও কাজ করবে।

2. **ওয়েবসাইট থেকে সরাসরি বাটন:**
   - ফুটারে থাকা **"অ্যাডমিন প্যানেল (/adminriad)"** লিঙ্কে ক্লিক করুন।
   - মোবাইল মেনু বা কাস্টমার লগইন মডালের নিচে থাকা অ্যাডমিন লিঙ্কেও ক্লিক করতে পারবেন।

3. **অ্যাডমিন লগইন তথ্য (Admin Credentials):**
   - **ইমেইল (Email):** `banglag215@gmail.com`
   - **পাসওয়ার্ড (Password):** `205090`
   - **অ্যাডমিন রাউট (Admin Route):** `/adminriad`
